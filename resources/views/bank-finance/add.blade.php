    ...
    <div class="col-md-12">
        <div class="ms-panel">
            ...
            <div class="ms-panel-body">
                <form action="{{route('bank-finance.store')}}" method="POST">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" value="{{$Selectrow->name}}" class="form-control" placeholder="Bank Name" disabled>
                            </div>
                        </div>
                        <div class="col-md-4 mb-3">
                            <div class="form-group">
                    ...
                    <div style="margin-bottom:25px">
                        <div style="border-bottom:solid 2px #0094ff;width:360px">
                            ...
                            <input type="radio" name="tab" value="4" onclick="show4();" clicked="clicked" /> bank to cashBox
                        </div>
