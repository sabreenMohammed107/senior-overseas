                ...
                <form action="{{route('bank-finance.update',$editrow->id)}}" method="POST">
                    ...
                    <div style="margin-bottom:25px">
                        <div style="border-bottom:solid 2px #0094ff;width:360px">
                            ...
                            ?>
                            @if($editrow->trans_type_id.equals(21))
                            <style>
                                .hide {
                                    display: none;
                                }
                            ...
                            @endif
                            @if($editrow->trans_type_id.equals(20))
                            <style>
                                .hide {
                                    display: none;
                                }
                            ...
                            <input type="radio" name="tab" value="4" onclick="show4();" checked />Bank to cashBox
                            @endif
                            @if(!$editrow->trans_type_id.equals(2) && !$editrow->trans_type_id.equals(20) && !$editrow->trans_type_id.equals(21))
                            <style>
                                .hide {
                                    display: none;
                                }
                                ...
                                <div class="ms-auth-container row">
                                    <div class="col-md-6 mb-3">
                                        <div class="ui-widget form-group">
                                            ...
                                            <select name="CashBoxes_inOut" disabled class=" form-control" data-live-search="true">
                                                <option value=''>Select </option>
                                                @foreach ($banksCashes as $data)
                                                <option value='{{$data->id}}' @if($cashesObjBank){{ $data->id == $cashesObjBank->cash_box_id ? 'selected' : '' }}@endif>
                                                    {{$data->name}}
                                                </option>
                                                @endforeach
                                            </select>
