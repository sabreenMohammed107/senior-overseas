							...
							<div class="ms-auth-container row">
								<div class="col-md-6 mb-3 " id="exist">
									<div class="ui-widget form-group">
										...
										<select name="sales_quote_id" class="form-control dynamic" data-dependent="allData" data-show-subtext="true" data-live-search="true" id="exist">
								...
								<div class="col-md-6 mb-3">
									<div class="ui-widget form-group fake" id="fake">
										...
										<select name="sales_quote_id" class=" form-control" data-live-search="true">
											<option value="">Select ...</option>
...
function existing() {
	...
	document.getElementById('fake').style.display = 'none';
	 $('#fake select[name="sales_quote_id"]').val('');
...
function fake() {
	...
	$('#exist select[name="sales_quote_id"]').val('');
}
