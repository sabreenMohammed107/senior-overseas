																					...
																					<div class="ms-auth-container row">
																						...
																						<div class="col-md-6 mb-3">
																							<div class="form-group">
																								...
																								<input type="number" step="0.01" value="{{ $row->sale->clearance_price ?? 'Clearance Price' }}" class="form-control" placeholder="Clearance Price" disabled>
																							</div>
																						</div>
																						<div class="col-md-6 mb-3">
																							<div class="ui-widget form-group">
																					...
																					<div class="ms-auth-container row">
																						...
																						<div class="col-md-6 mb-3">
																							<div class="form-group">
																								...
																								<input type="number" step="0.01" value="{{$row->sale->door_door_price ?? 'Door to Door Price' }}" class="form-control" placeholder="Door to Door Price" disabled>
																							</div>
																						</div>
																						<div class="col-md-6 mb-3">
																							<div class="ui-widget form-group">
							...
							<div class="ms-auth-container row">
								...
								<div class="col-md-6 mb-3">
									<div class="ui-widget form-group">
										...
										<select class="form-control" disabled data-live-search="true" name="shipping_id">
											<option value="">Select ...</option>
