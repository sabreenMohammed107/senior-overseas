...
<br>
                    ...
                    <div class=" col-md-12 " style="margin-top:50px">
                        <div class="form_in">
                            ...
                            <div class="in_style">to: 
                            <a>{{$invoice->operation->sale->client->client_name ?? '' }} 
                            <br> {{$invoice->operation->sale->client->address ?? '' }}</a></div>
                        ...
                        <div class="form_in">
                            <div class="in_style" style="margin-left:120px">
                                ...
                                @endif
                                <a>
                                {{$invoice->operation->ocean->ocean->pol->port_name ?? '' }}{{$invoice->operation->air->air->aol->port_name ?? '' }}</a>
                            </div>
                            <div class="in_style" style="margin-left:120px">
                                @if($invoice->operation->ocean)
                                <span>Pod </span>
                                ...
                                <span></span>
                                @endif
                                <a>{{$invoice->operation->ocean->ocean->pod->port_name ?? '' }}{{$invoice->operation->air->air->aod->port_name ?? '' }}</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$index+1}}</td>
                                <td class="left strong"> @if($row->automatic == 1) 1111 {{$row->type->expense_name }} @else 222 {{$row->provider->expense_name}} @endif </td>
